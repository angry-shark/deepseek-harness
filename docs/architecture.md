...
| Add UI or editor integration | drive `ctx.agents` and render from `session/event`; the full-screen terminal front door is [`dsh-tui`](../packages/ui/tui/README.md) |
