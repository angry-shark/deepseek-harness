...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-workspace-ext': { kind: 'none', reason: 'Browser-side UI plugin layer; registers nothing model-facing.' },
  ...
  'packages/client/ui-market': { kind: 'none', reason: 'Browser-side market surface; presents Host-owned plugin state and registers nothing model-facing.' },
  ...
  'packages/host/plugin-market': { kind: 'none', reason: 'Host-side market store and Remotes; install/uninstall/status register no prompt, tool, message, or provider request.' },
